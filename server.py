...
# ---------------- PATHS ----------------
BASE_PATH = r"C:\Users\james\Documents\Coconut_Seedlings\Dataset4"
MODEL_PATH = os.path.join(BASE_PATH, "cnn_model4.h5")
SERVICE_ACCOUNT_PATH = os.path.join(BASE_PATH, "serviceAccountKey.json")

DASHBOARD_PATH = r"C:\Users\james\Documents\Coconut_Seedlings\seller-portal"
STATIC_PATH = os.path.join(DASHBOARD_PATH, "static")

# ---------------- FLASK SETUP ----------------
app = Flask(
    __name__,
    template_folder=DASHBOARD_PATH,
...
# ---------------- HELPER FUNCTIONS ----------------
def get_local_ip():
    """Detect LAN IP dynamically for Android app or browser access."""
...
def config():
    ...
    return jsonify({
        "server_ip": ip,
        "dashboard_url": f"http://{ip}:5000/dashboard.html",
        "admin_url": f"http://{ip}:5000/admin.html",
        "register_url": f"http://{ip}:5000/register.html",
